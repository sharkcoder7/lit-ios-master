...
-(void)initializeValue{
    ...
    parentLayer.emitterPosition = CGPointMake([[UIScreen mainScreen] bounds].size.width / 2.0, -30);
    parentLayer.emitterSize		= CGSizeMake([[UIScreen mainScreen] bounds].size.width * 2.0, 0);
