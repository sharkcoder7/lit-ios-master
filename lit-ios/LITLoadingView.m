...
#import "LITLoadingView.h"
#import "LITRect.h"

@interface LITLoadingView ()
...
- (void)layoutSubviews {
    ...
    CGRect activityIndicatorFrame = LITRectMakeWithSizeCenteredInRect(_activityIndicator.frame.size, bounds);
    activityIndicatorFrame.origin.x = startX;
    _activityIndicator.frame = activityIndicatorFrame;

    CGRect loadingLabelFrame = LITRectMakeWithSizeCenteredInRect(_loadingLabel.frame.size, bounds);
