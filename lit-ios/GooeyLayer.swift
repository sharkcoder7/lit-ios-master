...
class GooeyLayer: CALayer{
    ...
    override init() {
        let soundFileURL: NSURL = NSBundle.mainBundle().URLForResource("pop", withExtension: "aiff")!
        
        self.playerOne = try! AVAudioPlayer(contentsOfURL: soundFileURL)
    ...
    func animateGroup(as_ : [GooAnimation], opening: Bool){
