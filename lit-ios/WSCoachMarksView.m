...
NSUInteger const kLITKeyboardCoachTag = 0;
NSUInteger const kLITCellCoachTag = 1;
NSUInteger const kLITSingleTapCoachTag = 2;
NSUInteger const kLITLongPressCoachTag = 3;
NSUInteger const kLITContentFullCoachTag = 0;
NSUInteger const kLITContentHeaderCoachTag = 1;
NSUInteger const kLITContentFooterCoachTag = 2;
