...
{
    AKTagCell *tag = (AKTagCell*)self.selectedTags[indexPath.row];
    
    NSMutableString *str = [NSMutableString stringWithFormat:@"#%@", [tag.tagName uppercaseString]];
	return [AKTagCell preferredSizeWithTag:str deleteButtonEnabled:self.allowDeleteTags];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    AKTagCell *tag = (AKTagCell*)self.selectedTags[indexPath.row];
	cell.tagName = [NSMutableString stringWithFormat:@"#%@",[tag.tagName uppercaseString]];
	cell.delegate = self;
...
{
	cell.backgroundColor = WK_COLOR_TAG_BACKGROUND_COLOR;
